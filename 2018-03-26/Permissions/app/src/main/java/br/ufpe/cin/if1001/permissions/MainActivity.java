        ...
        btn_location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (podeLocation()) {
                    ...
                    ActivityCompat.requestPermissions(MainActivity.this,LOCATION_PERMISSIONS, LOCATION_REQUEST);
                }
            }
        });
        ...
        btn_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (podeCamera()) {
                    ...
                    ActivityCompat.requestPermissions(MainActivity.this,CAMERA_PERMISSIONS, CONTACTS_REQUEST);
                    /*
        ...
        btn_contacts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (podeContacts()) {
                    ...
                    ActivityCompat.requestPermissions(MainActivity.this,CONTACTS_PERMISSIONS, CONTACTS_REQUEST);
                    /*
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
