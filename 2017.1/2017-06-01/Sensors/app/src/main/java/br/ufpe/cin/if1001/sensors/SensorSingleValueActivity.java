...
public class SensorSingleValueActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        String sName = i.getStringExtra(SensorManagerActivity.SENSOR_NAME);
        if (sName == null) {
            finish();
        }

        int sType = i.getIntExtra(SensorManagerActivity.SENSOR_TYPE,Sensor.TYPE_ALL);
