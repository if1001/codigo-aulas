...
public class MusicPlayerWithBindingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent musicServiceIntent = new Intent(getApplicationContext(), MusicPlayerWithBindingService.class);
        //inicia o service de cara
        ...
        final Button stopButton = (Button) findViewById(R.id.botaoPause);
