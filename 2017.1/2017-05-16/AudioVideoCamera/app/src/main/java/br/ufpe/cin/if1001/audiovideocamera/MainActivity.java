    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),AudioPlaybackActivity.class));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),VideoPlaybackActivity.class));
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),CameraAppActivity.class));
            }
        });
