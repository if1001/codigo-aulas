...
public class NotificationManagerActivity extends AppCompatActivity {
    ...
    private Uri soundURI = Uri.parse("android.resource://"+ MainActivity.Companion.getPACKAGE_NAME() +"/" + R.raw.alarm_rooster);
    private long[] mVibratePattern = { 0, 200, 200, 300 };

    NotificationManager mNotifyManager;
    NotificationCompat.Builder mBuilder;

    RemoteViews mContentView = new RemoteViews(MainActivity.Companion.getPACKAGE_NAME(), R.layout.custom_notification);
    RemoteViews mCustomActionView = new RemoteViews(MainActivity.Companion.getPACKAGE_NAME(), R.layout.custom_notification_action);
