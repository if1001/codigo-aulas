...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btn_MainThread = (Button) findViewById(R.id.botao_mainThread);
        btn_MainThread.setOnClickListener(new View.OnClickListener() {
            public void onClick(View src) {
                startActivity(new Intent(getApplicationContext(),MainThreadServiceActivity.class));
            }
        });
